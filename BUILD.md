# Сборка, CI/CD и версии

Подробности о версиях зависимостей, устройстве Gradle-конфигурации,
переименовании пакета и настройке сборки/подписи в GitHub Actions.
Общее описание приложения — в [README.md](README.md).
